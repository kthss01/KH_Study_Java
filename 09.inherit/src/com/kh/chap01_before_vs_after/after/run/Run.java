...
public class Run {
	 ...
	 *  - 부모클래스의 생성자와 초기화 블록은 상속이 불가능하다 (자식 클래스 생성시 부모클래스 생성자가 먼저 실행)
	...
	public static void main(String[] args) {
		...
		SmartPhone s = new SmartPhone("애플", "s_01", "KH아이폰", 20000000, "SK");
		...
		d.print();
		// 실행하고자 하는 메소드가 자식에 없으면 부모 메소드가 실행.
		// 단, 자식이 메소드를 동일하게 작성이 되어있으면 자식 메소드가 우선권을 가짐
		// 오버라이딩 - 부모 클래스의 메소드를 자식 클래스에서 재정의해서 사용하는 것.
	}
