...
//		String name = sc.next(); // 공백이 있는 경우 공백 이전까지 읽어옴
	...
	public void inputScanner2() {
		 ...
		 * 즉, 엔터까지 모두 읽어온다. 다시 말하면 나이를 입력할 때 sc.nextInt() 할 때 데이터를 입력하고 엔터를 쳤을 때 
...
//		System.out.println(name + " 님은 " + age + "세이며, 사는 곳은 " + address + "이고, 키는 " + height + " cm 입니다.");
		System.out.printf("%s님은 %d세이며, 사는 곳은 %s이고, 키는 %.2fcm 입니다.\n", name, age, address, height);
	}
