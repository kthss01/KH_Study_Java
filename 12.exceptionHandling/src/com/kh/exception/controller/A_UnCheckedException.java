...
//		System.out.println("result : " + result); // 사용자가 num2에 0을 입력하면 비정상적으로 종료
...
//			System.out.println("배열크기 잘못지정했네");
//		} catch (NullPointerException e) {
//			System.out.println("객체도 업이 메소드 쓰려고 하네 ");
			
		// Multi catch 문 --> 나란히 작성하는 경우 형제 레벨만 함께 사용
		// 자바 향상된 예외 처리	
		} catch (ClassCastException | ArrayIndexOutOfBoundsException | NullPointerException e) {
			System.out.println("잘못형변환 했네 ~ 다형성 복습 ");
//			e.printStackTrace(); // 가장 많이 써봄
//			System.out.println(e.getMessage());
//			System.out.println(e.toString());
			System.out.println(e);
//			System.exit(0); // 0은 정상 종료, 프로그램 강제 종료
//			return;
		} finally {
			System.out.println("여전히 실행하네 "); // catch에서 강제 종료하면 실행 안됨
		}
		
		System.out.println("출력 "); // return 아예 안쓰면 여기까지 실행
